...
- [clear blue seas](/challenges.md#clear-blue-seas)
  - my dream is that the entire factory is built on a giant rock platform (so dig everything out), having only a small part of the map remaning untouched.
- [1 groundwater reserve limit](/challenges.md#groundwater-pump-limit)
  - mostly for aesthetics, cause I don't really want to run pipes up the mountain
- [small forests](/challenges.md#abnormal-forest-sizes)
  - forces player to get wood from sawmill earlier and also requires ship to be in port until a cargo ship can make the trip so the ship can go exploring/fighting.
- [large resources](/challenges.md#abnormal-resource-sizes)
  - for this map in particular, the coal mine in the front choke is going to occupying precious farming land.
- [elevated resources](/challenges.md#abnormal-resource-sizes)
  - makes only one spot able to have a trading dock, and a limestone vein blocks immediate access to it.
...
- crude for vp2 contract
- crude for iron contract

long term goals:
- sustainable island

[captain's log](/c-logs/q-log.md)
